...
if(isset($_SESSION["user_name"]))
{
	...
	$targetBags = mysqli_query($con,"SELECT * FROM targetbags_ultra ORDER BY date DESC") or die(mysqli_error($con));		 
?>
<html>
<head>
				...
				<div class="btn-group" role="group" aria-label="Button group with nested dropdown" style="float:left;margin-left:2%;">
					<div class="btn-group" role="group">
						...
						<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="cursor:pointer">
							<li><a href="../TargetUltra/list.php?" class="dropdown-item">Monthly Points</a></li>
							<li><a href="../points_full_ultra/mainPage.php?" class="dropdown-item">Accumulated Points</a></li>
							<li><a href="../TargetUltra/edit.php?" class="dropdown-item">Update Target</a></li>
						</ul>
					</div>
				</div>					
				<span class="navbar-brand" style="font-size:25px;"><i class="fa fa-chart-line"></i> Target Bags</span>
				<a href="#" class="btn btn-sm" role="button" style="background-color:#54698D;color:white;float:right;margin-right:7%;" data-toggle="modal" data-target="#newModal"><i class="fa fa-bolt"></i> New</a>			
			</nav>
			<br/><br/>			
