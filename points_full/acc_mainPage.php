...
if(isset($_SESSION["user_name"]))
{
	...
	require 'acc_getTargetMap.php';
	require 'acc_getTargetExtrasMap.php';
	require 'acc_getSaleMap.php';
	require 'acc_getSpecialTargetMap.php';	
	require 'acc_getBoosterMap.php';	
	require '../SpecialTarget/acc_dropDownGenerator.php';
	...
	{	
		...
		$sales = mysqli_query($con,"SELECT ar_id,SUM(qty),SUM(return_bag) FROM nas_sale WHERE 
									...
									product IN (SELECT Id FROM products WHERE brand = 'ACC' AND category = 'CEMENT')
				...
				<div class="btn-group" role="group" aria-label="Button group with nested dropdown" style="float:left;margin-left:2%;">
					<div class="btn-group" role="group">
						...
						<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="cursor:pointer">
							<li><a href="../Target/acc_list.php?" class="dropdown-item">Monthly Points</a></li>
							<li><a href="../Target/acc_edit.php?" class="dropdown-item">Update Target</a></li>
						</ul>
					</div>
				</div>					
