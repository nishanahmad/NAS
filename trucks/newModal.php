			...
			<div class="modal-body">
				...
				<div class="col col-md-8 offset-1">
					<div class="input-group mb-3">
						<span class="input-group-text col-md-4"><i class="fa fa-user"></i>&nbsp;Driver</span>
							<input type="text" name="driver" id="driver" class="form-control" autocomplete="off">
					</div>
				</div>
				<div class="col col-md-8 offset-1">
					<div class="input-group mb-3">
				...
				<div class="col col-md-10 offset-1">
					<div class="input-group mb-3">
						...
						<input type="text" name="license_no" id="license_no" class="form-control" autocomplete="off">
					</div>
				</div>
				<div class="col col-md-10 offset-1">
					<div class="input-group mb-3">
						<span class="input-group-text col-md-4"><i class="fa fa-square"></i>&nbsp;Vehicle Type</span>
						<input type="text" name="vehicle_type" id="vehicle_type" class="form-control" autocomplete="off">
					</div>
				</div>
				<div class="col col-md-10 offset-1">
					<div class="input-group mb-3">
						<span class="input-group-text col-md-4"><i class="fa fa-map"></i>&nbsp;Vehicle Area</span>
						<input type="text" name="vehicle_area" id="vehicle_area" class="form-control" autocomplete="off">
					</div>
				</div>
				<br/><br/>
				<div class="row">
