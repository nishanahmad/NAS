...
if(isset($_SESSION["user_name"]))
{
	...
	$arObjects =  mysqli_query($con,"SELECT id,name,mobile,shop_name,sap_code FROM ar_details WHERE  isActive = 1 AND id NOT IN ('$zeroTargetIds') ORDER BY name ASC ") or die(mysqli_error($con));		 
