...
if(isset($_SESSION["user_name"]))
{
	...
	$targetIds = getTargetIdsUltra($lastTargetYear,$lastTargetMonth,$con);
...
<body>
	<div id="main" class="main">
		...
		<div class="container">		
			...
			<br/><br/>
			<form name="arBulkUpdate" method="post" action="ut_insert.php">
				<table class="table table-hover table-bordered offset-2" style="margin-left:35%;width:45%">
					...
					<tbody>																													<?php
						$targetList = mysqli_query($con, "SELECT * FROM target_ultra t LEFT JOIN ar_details a ON t.ar_id = a.id WHERE t.year = $lastTargetYear AND t.month = $lastTargetMonth AND t.ar_id IN ('$targetIds') ORDER BY a.name") or die(mysqli_error($con));
