	...
	<body>
		...
		<?php
			...
			foreach($files as $file)
			{
				...
				{
					$row = explode(",",$str);
					$message = "DEAR AR,YOUR BALANCE TO ACHIEVE YOUR SPECIAL TARGET OF 11th TO 18th Dec IS ".$row[1]." BAGS. ACHIEVE YOUR TARGET , EARN SPECIAL BENEFITS & LAKSHYA BENIFITS - AR HELP";
					$phone = '91'.$row[0];
					echo $phone.'<br/>';
					echo $message.'<br/>';
					sleep(2);
