...
if(isset($_SESSION["user_name"]))
{
	...
	$sql = "SELECT ar_id, target, rate, payment_perc, multiplier FROM target_ultra WHERE year='$year' AND month='$month' AND ar_id IN ('$array')";
	$result = mysqli_query($con, $sql) or die(mysqli_error($con));		

	$yearObjects = mysqli_query($con,"SELECT DISTINCT year FROM target_ultra ORDER BY year DESC");	
	...
	<div id="main" class="main">
		...
		<div class="container">		
			<nav class="navbar navbar-light bg-light sticky-top bottom-nav" style="margin-left:12.5%;width:100%">
				...
				<a href="ut_new.php?year=<?php echo $nextYear;?>&month=<?php echo $nextMonth;?>" class="btn btn-sm" style="background-color:#54698D;color:white;float:right;margin-right:5%;"><i class="fa fa-chart-line"></i> Generate <?php echo getmonth($nextMonth);?> Target</a>
			</nav>
			...
			<br/><br/>			
			<form name="arBulkUpdate" method="post" action="ut_update.php">
