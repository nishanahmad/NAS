...
if(isset($_SESSION["user_name"]))
{
	...
	$targetIds = getTargetIdsAcc($lastTargetYear,$lastTargetMonth,$con);
	$targetIds = implode("','",$targetIds);
	
	$zeroTargetIds = getZeroTargetIdsAcc($lastTargetYear,$lastTargetMonth,$con);
...
<body>
	<div id="main" class="main">
		...
		<div class="container">		
			...
			<br/><br/>
			<form name="arBulkUpdate" method="post" action="acc_insert.php">
