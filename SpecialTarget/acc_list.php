...
if(isset($_SESSION["user_name"]))
{
	...
	require 'acc_dropDownGenerator.php';
	require '../navbar.php';
	...
	{
		$sales = mysqli_query($con,"SELECT ar_id,SUM(qty),SUM(return_bag) FROM nas_sale WHERE deleted IS NULL AND entry_date >= '$fromDate' AND 
											entry_date <= '$toDate' AND entry_date < CURDATE() AND
											ar_id IN ('$array') AND
