...
if(isset($_SESSION["user_name"]))
{
	...
	if(isset($_GET['fromDate']) && isset($_GET['toDate']))
	{
		...
		$arObjects = mysqli_query($con, "SELECT id,name FROM ar_details WHERE isActive = 1 AND type NOT LIKE '%Only%' ORDER BY name asc") or die(mysqli_error($con)) or die(mysqli_error($con));		 						
