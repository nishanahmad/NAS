...
{			
	$clients = mysqli_query($con,"SELECT id,name FROM ar_details WHERE type= 'AR/SR' OR Type = 'Engineer' ORDER BY name ASC");
	$engineers = mysqli_query($con,"SELECT id,name FROM ar_details WHERE Type = 'Engineer Only' ORDER BY name ASC");
