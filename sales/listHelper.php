...
{	
	...
	else
	{
		...
		{
			if( !(fnmatch("B*",$sale['bill_no']) || fnmatch("C*",$sale['bill_no']) || fnmatch("D*",$sale['bill_no']) || fnmatch("GB*",$sale['bill_no']) || fnmatch("GC*",$sale['bill_no']) || fnmatch("PB*",$sale['bill_no']) || fnmatch("TRF*",$sale['bill_no']) || fnmatch("PC*",$sale['bill_no'])))
			{
				$saleArray = array();
