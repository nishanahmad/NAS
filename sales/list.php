...
<html>
	...
	<body>
		<nav class="navbar navbar-light bg-light sticky-top bottom-nav">
			...
			<a href="#" class="btn btn-sm" role="button" style="background-color:#54698D;color:white;float:right;margin-right:40px;" data-toggle="modal" data-target="#saleModal"><i class="fa fa-bolt"></i> New Sale</a>			
		</nav>
		<div style="width:100%;" class="mainbody">	
			...
			<br/><br/>
			<table class="maintable table table-hover table-bordered" style="width:95%;margin-left:40px;">
				<thead>
