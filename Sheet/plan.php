...
<body>
	...
	<div class="task-board">
		<div class="status-card">
			...
			{																																?>
				<li class="text-row ui-sortable-handle" data-sheet-id="<?php echo $sheet['id']; ?>"><?php echo $sheet['area'].'<br/>'.$sheet['name'].' - '.$sheet['bags'].' bags<br/><b>'.$sheet['requested_by'].'</b>'; ?></li>											<?php
			}																																?>
			</ul>
		</div>																																<?php	
