<?php
	...
	$drivers = mysqli_query($con,"SELECT user_id,user_name FROM users WHERE role = 'driver' AND active=1 AND user_name != 'Damage' user_name != 'New Sheet Inventory' ORDER BY assign_order ASC") or die(mysqli_error($con));	
